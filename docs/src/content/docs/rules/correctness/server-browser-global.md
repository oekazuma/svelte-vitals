...
- Code guarded by `browser` from `$app/environment` (or SvelteKit 3's `$app/env`; aliases included) or a `typeof` check such as `typeof window !== 'undefined'` or `typeof matchMedia === 'function'` (early-return guards included).
