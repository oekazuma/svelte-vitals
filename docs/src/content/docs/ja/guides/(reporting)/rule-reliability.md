...
コーパスでの検出 5931 件のうち、判定済みは 1288 件です。

| ルール                                                                                     | コーパスでの検出数 | アプリ数 | レビュー済み (tp / fp / design / unclear) | 適合率 |
| ------------------------------------------------------------------------------------------ | ------------------ | -------- | ----------------------------------------- | ------ |
| [`a11y/abbr-title`](/ja/rules/a11y/abbr-title)                                             | 0                  | 0        | —                                         | —      |
| [`a11y/accessible-name`](/ja/rules/a11y/accessible-name)                                   | 6                  | 1        | 6 / 0 / 0 / 0                             | 100%   |
| [`a11y/aria-hidden-focus`](/ja/rules/a11y/aria-hidden-focus)                               | 3                  | 2        | 3 / 0 / 0 / 0                             | 100%   |
| [`a11y/deprecated-aria`](/ja/rules/a11y/deprecated-aria)                                   | 1                  | 1        | 1 / 0 / 0 / 0                             | 100%   |
...
| [`a11y/disallowed-aria-props`](/ja/rules/a11y/disallowed-aria-props)                       | 29                 | 7        | 1 / 0 / 0 / 0                             | 100%   |
| [`a11y/disallowed-element`](/ja/rules/a11y/disallowed-element)                             | 0                  | 0        | —                                         | —      |
| [`a11y/doctype`](/ja/rules/a11y/doctype)                                                   | 0                  | 0        | —                                         | —      |
| [`a11y/duplicate-landmark`](/ja/rules/a11y/duplicate-landmark)                             | 4                  | 3        | 2 / 0 / 2 / 0                             | 100%   |
| [`a11y/id-duplication`](/ja/rules/a11y/id-duplication)                                     | 101                | 5        | 14 / 0 / 54 / 0                           | 100%   |
| [`a11y/interactive-nesting`](/ja/rules/a11y/interactive-nesting)                           | 60                 | 4        | 11 / 0 / 0 / 0                            | 100%   |
| [`a11y/invalid-aria-value`](/ja/rules/a11y/invalid-aria-value)                             | 0                  | 0        | —                                         | —      |
| [`a11y/invalid-role`](/ja/rules/a11y/invalid-role)                                         | 0                  | 0        | —                                         | —      |
| [`a11y/label-has-control`](/ja/rules/a11y/label-has-control)                               | 1                  | 1        | 1 / 0 / 0 / 0                             | 100%   |
| [`a11y/no-accesskey`](/ja/rules/a11y/no-accesskey)                                         | 0                  | 0        | —                                         | —      |
| [`a11y/no-autofocus`](/ja/rules/a11y/no-autofocus)                                         | 2                  | 1        | 2 / 0 / 0 / 0                             | 100%   |
| [`a11y/no-duplicate-dt`](/ja/rules/a11y/no-duplicate-dt)                                   | 0                  | 0        | —                                         | —      |
| [`a11y/no-missing-id-ref`](/ja/rules/a11y/no-missing-id-ref)                               | 0                  | 0        | —                                         | —      |
| [`a11y/pattern-title`](/ja/rules/a11y/pattern-title)                                       | 2                  | 2        | 2 / 0 / 0 / 0                             | 100%   |
| [`a11y/permitted-contents`](/ja/rules/a11y/permitted-contents)                             | 796                | 15       | 458 / 0 / 0 / 0                           | 100%   |
| [`a11y/placeholder-label-option`](/ja/rules/a11y/placeholder-label-option)                 | 2                  | 1        | 2 / 0 / 0 / 0                             | 100%   |
| [`a11y/positive-tabindex`](/ja/rules/a11y/positive-tabindex)                               | 0                  | 0        | —                                         | —      |
| [`a11y/require-datetime`](/ja/rules/a11y/require-datetime)                                 | 0                  | 0        | —                                         | —      |
| [`a11y/required-aria-props`](/ja/rules/a11y/required-aria-props)                           | 1                  | 1        | 1 / 0 / 0 / 0                             | 100%   |
| [`a11y/required-element`](/ja/rules/a11y/required-element)                                 | 0                  | 0        | —                                         | —      |
| [`a11y/top-level-landmark`](/ja/rules/a11y/top-level-landmark)                             | 6                  | 5        | 5 / 0 / 0 / 0                             | 100%   |
...
| [`correctness/base-path-navigation`](/ja/rules/correctness/base-path-navigation)           | 34                 | 2        | 34 / 0 / 0 / 0                            | 100%   |
| [`correctness/checkable-bind-value`](/ja/rules/correctness/checkable-bind-value)           | 0                  | 0        | —                                         | —      |
| [`correctness/each-index-key`](/ja/rules/correctness/each-index-key)                       | 384                | 9        | 239 / 0 / 0 / 0                           | 100%   |
| [`correctness/each-key`](/ja/rules/correctness/each-key)                                   | 569                | 12       | 0 / 0 / 66 / 0                            | —      |
| [`correctness/effect-as-derived`](/ja/rules/correctness/effect-as-derived)                 | 4                  | 3        | 4 / 0 / 0 / 0                             | 100%   |
| [`correctness/effect-as-onmount`](/ja/rules/correctness/effect-as-onmount)                 | 3                  | 2        | 3 / 0 / 0 / 0                             | 100%   |
| [`correctness/instance-browser-global`](/ja/rules/correctness/instance-browser-global)     | 1                  | 1        | 1 / 0 / 0 / 0                             | 100%   |
...
| [`correctness/prop-mutation`](/ja/rules/correctness/prop-mutation)                         | 37                 | 7        | 2 / 4 / 11 / 0                            | 33%    |
...
| [`performance/load-waterfall`](/ja/rules/performance/load-waterfall)                       | 4                  | 3        | 3 / 0 / 0 / 1                             | 100%   |
...
| [`performance/responsive-image`](/ja/rules/performance/responsive-image)                   | 62                 | 9        | 未レビュー                                | —      |
...
| [`security/raw-html`](/ja/rules/security/raw-html)                                         | 97                 | 13       | 97 / 0 / 0 / 0                            | 100%   |
| [`security/server-module-state`](/ja/rules/security/server-module-state)                   | 3                  | 2        | 3 / 0 / 0 / 0                             | 100%   |
| [`security/shared-state-import`](/ja/rules/security/shared-state-import)                   | 0                  | 0        | —                                         | —      |
| [`seo/canonical-url`](/ja/rules/seo/canonical-url)                                         | 333                | 15       | 未レビュー                                | —      |
| [`seo/charset`](/ja/rules/seo/charset)                                                     | 0                  | 0        | —                                         | —      |
| [`seo/description-length`](/ja/rules/seo/description-length)                               | 27                 | 5        | 未レビュー                                | —      |
| [`seo/description-presence`](/ja/rules/seo/description-presence)                           | 135                | 10       | 未レビュー                                | —      |
| [`seo/duplicate-description`](/ja/rules/seo/duplicate-description)                         | 4                  | 2        | 4 / 0 / 0 / 0                             | 100%   |
| [`seo/duplicate-title`](/ja/rules/seo/duplicate-title)                                     | 4                  | 4        | 4 / 0 / 0 / 0                             | 100%   |
| [`seo/heading-level-skip`](/ja/rules/seo/heading-level-skip)                               | 60                 | 4        | 48 / 0 / 0 / 0                            | 100%   |
| [`seo/hreflang`](/ja/rules/seo/hreflang)                                                   | 0                  | 0        | —                                         | —      |
| [`seo/html-lang`](/ja/rules/seo/html-lang)                                                 | 2                  | 2        | 2 / 0 / 0 / 0                             | 100%   |
| [`seo/image-alt`](/ja/rules/seo/image-alt)                                                 | 0                  | 0        | —                                         | —      |
| [`seo/indexability`](/ja/rules/seo/indexability)                                           | 86                 | 3        | 86 / 0 / 0 / 0                            | 100%   |
| [`seo/json-ld`](/ja/rules/seo/json-ld)                                                     | 528                | 16       | 未レビュー                                | —      |
...
| [`seo/og-description`](/ja/rules/seo/og-description)                                       | 220                | 12       | 未レビュー                                | —      |
| [`seo/og-image`](/ja/rules/seo/og-image)                                                   | 240                | 13       | 未レビュー                                | —      |
| [`seo/og-title`](/ja/rules/seo/og-title)                                                   | 219                | 12       | 未レビュー                                | —      |
| [`seo/og-url`](/ja/rules/seo/og-url)                                                       | 282                | 13       | 未レビュー                                | —      |
| [`seo/robots-txt`](/ja/rules/seo/robots-txt)                                               | 6                  | 6        | 6 / 0 / 0 / 0                             | 100%   |
| [`seo/single-h1`](/ja/rules/seo/single-h1)                                                 | 169                | 16       | 74 / 0 / 1 / 0                            | 100%   |
| [`seo/sitemap-in-robots`](/ja/rules/seo/sitemap-in-robots)                                 | 1                  | 1        | 未レビュー                                | —      |
| [`seo/sitemap-xml`](/ja/rules/seo/sitemap-xml)                                             | 12                 | 12       | 12 / 0 / 0 / 0                            | 100%   |
| [`seo/ssr-disabled`](/ja/rules/seo/ssr-disabled)                                           | 7                  | 4        | 7 / 0 / 0 / 0                             | 100%   |
| [`seo/title-length`](/ja/rules/seo/title-length)                                           | 51                 | 10       | 3 / 0 / 0 / 0                             | 100%   |
| [`seo/title-presence`](/ja/rules/seo/title-presence)                                       | 14                 | 5        | 未レビュー                                | —      |
| [`seo/twitter-card`](/ja/rules/seo/twitter-card)                                           | 258                | 12       | 未レビュー                                | —      |
