...
| ------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/gallery/a11y/aria`                                                            | `a11y/invalid-role`, `a11y/unknown-aria-attribute`, `a11y/required-aria-props`, `a11y/invalid-aria-value`, `a11y/interactive-nesting`, `a11y/accessible-name`, `a11y/label-has-control`, `a11y/use-list`, `a11y/placeholder-label-option`, `a11y/require-datetime`                                                     |
...
| `/gallery/correctness`                                                          | `correctness/each-key`, `correctness/each-index-key`, `correctness/effect-as-derived`, `correctness/effect-as-onmount`, `correctness/unmutated-state`, `correctness/nonreactive-builtin-state`, `correctness/checkable-bind-value`, `correctness/prop-mutation`, `correctness/stale-prop-derivation`                   |
...
| `src/app.html` (project-scoped, not one route)                                  | `a11y/doctype`, `seo/html-lang`, `seo/charset`, `seo/viewport`                                                                                                                                                                                                                                                         |
