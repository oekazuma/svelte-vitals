...
| ------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `/gallery/a11y/aria`                                                            | `a11y/invalid-role`, `a11y/unknown-aria-attribute`, `a11y/required-aria-props`, `a11y/invalid-aria-value`, `a11y/interactive-nesting`, `a11y/accessible-name`, `a11y/label-has-control`, `a11y/use-list`, `a11y/placeholder-label-option`, `a11y/require-datetime`, `a11y/disallowed-aria-props`, `a11y/deprecated-aria`, `a11y/permitted-contents`, `a11y/positive-tabindex`, `a11y/no-accesskey`, `a11y/no-autofocus` |
...
| `/gallery/a11y/legacy`                                                          | `a11y/deprecated-element`, `a11y/deprecated-attr`, `a11y/disallowed-element`, `a11y/required-element`, `performance/iframe-loading`                                                                                                                                                                                                                                                                                     |
...
- The `<iframe>` on `/gallery/a11y/legacy` is the **only** iframe in the app and carries three
  planted rules at once: `a11y/deprecated-attr` (`frameborder`), `a11y/disallowed-element` (the
  config declares `iframe`), and `performance/iframe-loading` (no `loading` attribute). The
  suppression e2e also rewrites this exact element by full-string match. Adding `loading="lazy"`,
  removing `frameborder`, or planting a second iframe anywhere breaks pinned counts in three test
  files at once.
