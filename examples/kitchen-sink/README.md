...
| `/gallery/seo/spa-shell`                                                        | `seo/ssr-disabled` (prerendered as the empty app shell — the rendered build e2e asserts the plugin skips it)                                                                                                                                                                                                                                                                                                                                                                                                       |
