...
export function buildConfigFileTemplate(opts: { useDefineConfig?: boolean } = {}): string {
  ...
  // type-checking/autocomplete for the fields above); a plain object export would give a
  // TypeScript config no benefit over a .mjs one, defeating the point of the choice.
