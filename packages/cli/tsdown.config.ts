...
export default defineConfig({
  ...
  // consumer. The three install/ entries exist for the same reason: scripts/gen-skills.js imports
  ...
  entry: {
    ...
    'install/setup-skill-content': 'src/install/setup-skill-content.ts'
  },
  format: ['esm'],
