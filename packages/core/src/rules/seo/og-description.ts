...
export const seoOgDescription = headTagRule({
  ...
  rationale:
    'og:description is the summary shown under the title in social previews; without it platforms guess or show nothing, lowering click-through. The Open Graph protocol lists it as an optional property.',
  fix: {
